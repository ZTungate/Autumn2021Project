...
namespace Sprint2.Player
{
    public class LeftSwordLinkSprite : IAnimatedSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Texture, new Vector2(player.position.X + 27 , player.position.Y), SourceRect[CurrentFrame % FrameCount], player.color, 0, new Vector2(SourceRect[CurrentFrame % FrameCount].Width, 0), scale, SpriteEffects.FlipHorizontally, 1);
