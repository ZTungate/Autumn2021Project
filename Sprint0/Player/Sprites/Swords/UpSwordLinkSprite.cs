...
namespace Sprint2.Player
{
    public class UpSwordLinkSprite : IAnimatedSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Texture, new Vector2(player.position.X, player.position.Y + 27), SourceRect[CurrentFrame % FrameCount], player.color, 0, new Vector2(0, SourceRect[CurrentFrame % FrameCount].Height), scale, SpriteEffects.None, 1);
