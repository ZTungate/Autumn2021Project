...
{
    public class DownSwordLinkSprite : IAnimatedSprite
    {
        ...
        ILink player;
        public DownSwordLinkSprite(Texture2D spriteSheet, ILink player)
        {
            this.player = player;
            ...
            SourceRect[0] = new Rectangle(1, 47, 16, 16);  //Set the frame for right idle link
