...
namespace Sprint2
{
    public class DownRightSwordExplosionSprite : IAnimatedSprite
    {
        ...
        public DownRightSwordExplosionSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Texture, Position, SourceRect[CurrentFrame % FrameCount], Color.White, 0, new Vector2(0, 0), scale, SpriteEffects.FlipVertically | SpriteEffects.FlipHorizontally, 1);
